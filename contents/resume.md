...
[LinkedIn](https://linkedin.com/in/izumisy) · [GitHub](https://github.com/IzumiSy) · Chiba, Japan

---

## Summary

Eight years building platforms that make the right thing easy and the wrong thing a compile error. Frontend-focused but fully end-to-end: I've led SAP replacement deliveries, designed typed SDKs consumed by internal teams, and redesigned a Go streaming pipeline at the codec level. My through-line is structural thinking: I look for the integration pain that teams work around repeatedly, then encode the solution once into types and conventions so it stops being a problem anyone has to solve again.
...
- These prototypes became the direct seed of AppShell; the engagement is where I was both the producer (shipping the customer system) and the consumer (feeling the platform's gaps), which shaped the API design philosophy for the framework.
